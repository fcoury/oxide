#![allow(dead_code)]
use crate::commands::{
    Aggregate, BuildInfo, CollStats, ConnectionStatus, Count, Create, CreateIndexes, DbStats,
    Delete, Drop, DropDatabase, Find, FindAndModify, GetCmdLineOpts, GetParameter, Handler, Hello,
